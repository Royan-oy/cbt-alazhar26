    ...
    <div class="page-header mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            <div>
                ...
                <p class="text-light opacity-75 mb-0 small">Tambahkan data siswa baru beserta penempatan kelasnya.</p>
            </div>
                ...
                <div class="form-section">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <small class="text-muted">Pilih jenjang untuk menyaring pilihan kelas.</small>
                        </div>
                        @endif
                ...
                <div class="form-section">
                    ...
                    <div class="password-box">
                        <div class="password-box-header">
                            <div>
                                <span class="password-title">Password Login</span>
                                <span class="password-subtitle">Digunakan siswa untuk masuk ke akun. Bisa dibuat otomatis atau diisi manual.</span>
                            </div>

...
<div class="container-fluid py-2">
    ...
    <div class="page-header mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            <div>
                ...
                <h3 class="fw-bold mb-1">Edit Wali Kelas</h3>
                <p class="text-light opacity-75 mb-0 small">Perbarui data penugasan wali kelas.</p>
            </div>
    ...
    <div class="card content-card">
        <div class="card-body p-4">
            ...
            @php
                $jenjangAktif = optional($waliKelas->guru)->jenjang_id;
            @endphp
                        ...
                        <select
                            ...
                            @foreach($gurus as $guru)
                                <option
                                    ...
                                    {{ old('guru_id', $waliKelas->guru_id) == $guru->id ? 'selected' : '' }}>
                                    {{ $guru->nama }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <select
                            ...
                            @foreach($kelasList as $kelas)
                                <option
                                    ...
                                    {{ old('kelas_id', $waliKelas->kelas_id) == $kelas->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        <select
                            ...
                            @foreach($tahunAjarans as $tahun)
                                <option
                                    value="{{ $tahun->id }}"
                                    {{ old('tahun_ajaran_id', $waliKelas->tahun_ajaran_id) == $tahun->id ? 'selected' : '' }}>

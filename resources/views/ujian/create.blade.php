    ...
    <div class="page-header mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            <div>
                ...
                <h3 class="fw-bold mb-1">Buat Jadwal Ujian</h3>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <input
                            ...
                            placeholder="Contoh: PTS Matematika Semester Ganjil"
                    ...
                    {{-- Jenjang (Super Admin saja, filter bantu) --}}
                    ...
                    <div class="col-md-4">
                        ...
                        <small class="text-muted">Menyaring pilihan bank soal & kelas.</small>
                    </div>
                    @endif
                    ...
                    <div class="col-md-{{ Auth::user()->role == 'super_admin' ? '4' : '6' }}">
                        ...
                        @enderror
                        <small class="text-muted">Hanya bank soal berstatus <strong>publish</strong> yang muncul di sini.</small>
                    </div>
                    ...
                    <div class="col-md-{{ Auth::user()->role == 'super_admin' ? '4' : '6' }}">
                        ...
                        <select
                            ...
                            @foreach($jenisUjians as $jenis)
                                <option value="{{ $jenis->id }}" {{ old('jenis_ujian_id') == $jenis->id ? 'selected' : '' }}>
                                    {{ $jenis->nama }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        @error('waktu_selesai')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                        <small class="text-muted">Rentang waktu jendela ujian boleh dibuka (bisa lebih lebar dari durasi pengerjaan).</small>
                    </div>

                    <div class="col-md-4">
                        <label class="form-label fw-semibold">
                            Durasi Minimal Pengerjaan (Menit)
                        </label>
                        ...
                        <small class="text-muted">
                            Peserta ujian dapat mengakhiri ujian setelah minimal waktu ini terpenuhi.
                        </small>
                    </div>
                        ...
                        <div class="row g-2">
                            <div class="col-md-6">
                                <div class="toggle-option">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="acak_soal" value="1" {{ old('acak_soal', true) ? 'checked' : '' }}>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="toggle-option">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="acak_jawaban" value="1" {{ old('acak_jawaban', true) ? 'checked' : '' }}>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="toggle-option">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="tampilkan_nilai" value="1" {{ old('tampilkan_nilai') ? 'checked' : '' }}>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="toggle-option">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="tampilkan_pembahasan" value="1" {{ old('tampilkan_pembahasan') ? 'checked' : '' }}>
                                    </div>
                                </div>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function filter(jenjangId) {
        ...
        filterSelect('bankSoal', jenjangId);
        ...
        document.querySelectorAll('.kelas-item').forEach(function (item) {
            ...
            if (item.dataset.jenjang === jenjangId) {

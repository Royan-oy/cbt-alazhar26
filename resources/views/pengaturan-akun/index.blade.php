        ...
        <div class="col-12 col-lg-4 sticky-profile-col">
            <div class="premium-card p-4 text-center">
                ...
                @if(isset($siswa) && $siswa->kelasAktif)
                    <span class="badge bg-primary bg-opacity-10 text-primary border border-primary border-opacity-25 px-3 py-2 rounded-pill fw-semibold" style="font-size: 12px;">
                        <i class="fa-solid fa-graduation-cap me-1"></i> Kelas {{ optional($siswa->kelasAktif->kelas)->nama_kelas }}
                    </span>
                @else
                    <span class="badge bg-warning bg-opacity-10 text-warning border border-warning border-opacity-25 px-3 py-2 rounded-pill fw-semibold" style="font-size: 12px;">
        ...
        <div class="col-12 col-lg-8">
            <div class="premium-card p-4 p-md-5">
                ...
                <div class="section-title mb-4">
                    <i class="fa-solid fa-id-card text-primary me-2"></i> Informasi Personal Siswa
                </div>
                ...
                <div class="section-title mt-5 mb-4">
                    <i class="fa-solid fa-clock-rotate-left text-primary me-2"></i> Riwayat Kelas & Akademik
                </div>
                                ...
                                @foreach($riwayatKelas as $sk)
                                    ...
                                    <tr style="border-bottom: 1px solid #f1f5f9; font-size: 14px;">
                                        ...
                                        <td class="py-3 px-3 text-center">
                                            @if($isAktif)
                                                <span class="badge bg-success bg-opacity-10 text-success border border-success border-opacity-25 px-3 py-1 rounded-pill" style="font-size: 11px;">
                                                    <i class="fa-solid fa-circle-check me-1"></i> Kelas Aktif
                                                </span>
                                            @else
                                                <span class="badge bg-secondary bg-opacity-10 text-secondary border border-secondary border-opacity-25 px-3 py-1 rounded-pill" style="font-size: 11px;">
                                                    Selesai
                                                </span>
                                            @endif
                                        </td>

            ...
            <div class="form-card-body">
                ...
                <div class="form-group">
                    ...
                    <select name="jenis_soal" id="jenisSoal" class="form-select-modern @error('jenis_soal') is-invalid @enderror" required>
                        ...
                        <option value="essay" {{ old('jenis_soal') == 'essay' ? 'selected' : '' }}>Essay</option>
                        <option value="isian" {{ old('jenis_soal') == 'isian' ? 'selected' : '' }}>Isian Singkat</option>
                    </select>
                    @error('jenis_soal')
                ...
                <div class="form-group">
                    ...
                    <textarea name="teks_soal" class="form-control-modern @error('teks_soal') is-invalid @enderror"
                              placeholder="Tulis pertanyaan di sini...">{{ old('teks_soal') }}</textarea>
                    @error('teks_soal')
                        <div class="field-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</div>
                    @enderror
                </div>
                        ...
                        <div id="opsiContainer">
                            @for ($i = 0; $i < 2; $i++)
                                <div class="opsi-row">
                                    ...
                                    <button type="button" class="btn-remove-opsi" onclick="removeOpsiRow(this)" disabled title="Hapus opsi">

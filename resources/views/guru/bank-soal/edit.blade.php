...
<div class="container-fluid py-2">
    ...
    <div class="page-header-create mb-4">
        ...
        <p class="text-light opacity-75 mb-0 small">
            Perbarui informasi bank soal "{{ $bankSoal->nama_bank_soal }}".
        </p>
    </div>
    ...
    <div class="form-card">
        ...
        <form action="{{ route('dashboard-guru.bank-soal.update', $bankSoal->id) }}" method="POST" id="formEditBankSoal">
            @csrf
            @method('PUT')
            ...
            <div class="form-card-body">
                ...
                <div class="info-tip">
                    ...
                    <p>Status Publish/Draft tidak diubah di sini — gunakan tombol publish/unpublish di halaman daftar Bank Soal.</p>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                           ...
                           value="{{ old('nama_bank_soal', $bankSoal->nama_bank_soal) }}"
                           required
                           autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <select name="guru_mapel_id"
                                ...
                                @foreach($guruMapels as $gm)
                                    <option value="{{ $gm->id }}" {{ old('guru_mapel_id', $bankSoal->guru_mapel_id) == $gm->id ? 'selected' : '' }}>
                ...
                <div class="form-group mt-3">
                    ...
                    <textarea name="deskripsi"
                              ...
                              rows="4"
                              placeholder="Tambahkan deskripsi atau catatan tentang bank soal ini...">{{ old('deskripsi', $bankSoal->deskripsi) }}</textarea>
                    @error('deskripsi')
                        <div class="field-error">
                            <i class="fa-solid fa-circle-exclamation"></i> {{ $message }}
                        </div>

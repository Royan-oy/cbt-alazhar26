                ...
                <div class="form-group mt-3">
                    ...
                    <div class="kategori-radio-group">
                        <label class="kategori-radio-wrapper">
                            <input type="radio" name="kategori" value="personal" class="kategori-radio-input" {{ old('kategori', 'personal') == 'personal' ? 'checked' : '' }} required>
                        ...
                        <label class="kategori-radio-wrapper">
                            <input type="radio" name="kategori" value="bersama" class="kategori-radio-input" {{ old('kategori') == 'bersama' ? 'checked' : '' }} required>
                            <div class="kategori-card">
                                <div class="kategori-icon-box">

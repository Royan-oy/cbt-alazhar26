                ...
                <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                    ...
                    <div class="d-flex align-items-center gap-2 flex-wrap">
                        <div class="dropdown d-inline-block">
                            <button class="export-btn dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false" style="background: linear-gradient(135deg, #ef4444, #dc2626); border: none; color: #ffffff;">
                                <i class="fa-solid fa-file-pdf fs-6"></i>
                                Export PDF
                            </button>
                            <ul class="dropdown-menu dropdown-menu-end shadow border-0" aria-labelledby="dropdownMenuButton" style="border-radius: 10px; min-width: 240px;">
                                <li>
                                    <a class="dropdown-item py-2 fw-semibold text-dark" style="font-size: 13px;" href="{{ route('dashboard-guru.wali-kelas.rekap-nilai.export-pdf') }}" target="_blank">
                                        <i class="fa-solid fa-list-ol me-2 text-danger"></i> Cetak Leaderboard Kelas
                                    </a>
                                </li>
                                <li id="pdf-jenis-ujian-li" style="display: none;">
                                    <a class="dropdown-item py-2 fw-semibold text-dark" id="btnExportPdfJenis" style="font-size: 13px;" href="#" target="_blank">
                                        <i class="fa-solid fa-table me-2 text-primary"></i> Cetak Matriks Ujian (<span id="pdf-jenis-ujian-text">-</span>)
                                    </a>
                                </li>
                            </ul>
                        </div>

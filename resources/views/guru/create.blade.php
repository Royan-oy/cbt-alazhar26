    ...
    <div class="page-header mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            <div>
                ...
                <p class="text-light opacity-75 mb-0 small">Tambahkan data guru baru beserta akun login.</p>
            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        @else
                            <input
                                ...
                                disabled>
                            <small class="text-muted">Guru otomatis ditambahkan ke jenjang Anda.</small>
                        @endif
                    </div>

...
@section('title', 'Edit Admin Jenjang')
...
<div class="container-fluid py-2">
    ...
    <div class="page-header mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            <div>
                ...
                <h3 class="fw-bold mb-1">Edit Admin Jenjang</h3>
                <p class="text-light opacity-75 mb-0 small">Perbarui data admin. Kosongkan password jika tidak ingin mengubahnya.</p>
            </div>
    ...
    <div class="card content-card">
        <div class="card-body p-4">
            ...
            <form method="POST" action="{{ route('admin-jenjang.update', $admin->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="jenjang_id" class="form-select form-control-custom @error('jenjang_id') is-invalid @enderror">
                            ...
                            @foreach($jenjangs as $jenjang)
                                <option value="{{ $jenjang->id }}" {{ old('jenjang_id', $admin->jenjang_id) == $jenjang->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        <input
                            ...
                            value="{{ old('email', optional($admin->user)->email) }}">
                        @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>

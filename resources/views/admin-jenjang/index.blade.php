...
<div class="container-fluid py-2">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            <div>
                ...
                <h3 class="fw-bold mb-1" style="letter-spacing: -0.5px;">
                    Manajemen Admin Jenjang
                </h3>
                <p class="text-light opacity-75 mb-0 small">
                    Kelola akun admin yang bertanggung jawab atas masing-masing jenjang.
                </p>
            </div>

            <a href="{{ route('admin-jenjang.create') }}" class="btn btn-info text-white btn-add d-inline-flex align-items-center">
    ...
    <div class="row g-3 mb-4">
        <div class="col-6 col-md-3">
            <div class="stat-card">
                ...
                <div>
                    <small class="text-muted d-block uppercase fw-semibold" style="font-size: 11px; letter-spacing: 0.5px;">TOTAL ADMIN JENJANG</small>
                    <h4 class="fw-bold text-dark mb-0 mt-1">{{ $totalAdmin }}</h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card content-card">
        <div class="card-body">
            ...
            {{-- Filter & Search Form --}}
            <form method="GET" action="{{ route('admin-jenjang.index') }}">
                    ...
                    <div class="col-lg-auto">
                        <div class="d-flex gap-2">
                            ...
                            @if(request()->filled('search') || request()->filled('jenjang'))
                                <a href="{{ route('admin-jenjang.index') }}" class="btn btn-light border btn-action-trigger">
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="d-inline-flex">
                                    ...
                                    <form action="{{ route('admin-jenjang.destroy', $item->id) }}"
                                        method="POST"
                        ...
                        <tr>
                            <td colspan="5">
                                <div class="text-center py-5">
                                    <i class="fa-solid fa-user-shield fa-3x text-muted mb-3 opacity-50"></i>
                                    <h6 class="fw-bold text-secondary">Belum ada admin jenjang</h6>
                                    <small class="text-muted">Silakan tambahkan admin jenjang baru.</small>
                                </div>
                            </td>
                        </tr>
                        @endforelse
...
document.querySelectorAll('.form-delete').forEach(function(form){
    form.addEventListener('submit', function(e){
        e.preventDefault();
        Swal.fire({
            title: 'Hapus Admin Jenjang?',
            text: 'Akun login admin ini akan ikut terhapus secara permanen.',
            icon: 'warning',

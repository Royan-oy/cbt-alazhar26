    ...
    <div class="page-header mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            <div>
                ...
                <p class="text-light opacity-75 mb-0 small">Perbarui data mata pelajaran.</p>
            </div>
                ...
                <div class="mb-4">
                    ...
                    @if(Auth::user()->role != 'admin_jenjang')
                        <select
                            ...
                            @foreach($jenjangs as $jenjang)
                                <option value="{{ $jenjang->id }}" {{ old('jenjang_id', $mataPelajaran->jenjang_id) == $jenjang->id ? 'selected' : '' }}>
                    ...
                    @else
                        <input
                            ...
                            value="{{ optional($mataPelajaran->jenjang)->nama_jenjang ?? '-' }}"
                            disabled>

...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .table-responsive td:nth-of-type(2):before { content: "Jenjang"; }
        .table-responsive td:nth-of-type(3):before { content: "Nama Mapel"; }
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            <div>
                ...
                <p class="text-light opacity-75 mb-0 small">
                    Kelola daftar mata pelajaran per jenjang pada platform CBT.
                </p>
            </div>

            <a href="{{ route('mata-pelajaran.create') }}" class="btn btn-info text-white btn-add d-inline-flex align-items-center">
    ...
    <div class="card content-card">
        <div class="card-body">
                    ...
                    <div class="col-lg-auto">
                        <div class="d-flex gap-2">
                            ...
                            @if(request()->filled('search') || request()->filled('jenjang'))
                                <a href="{{ route('mata-pelajaran.index') }}" class="btn btn-light border btn-action-trigger">
                        ...
                        <tr>
                            <td>
                                <span class="text-secondary fw-semibold">
                                    {{ $loop->iteration + ($mapels->firstItem() - 1) }}
                                </span>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="fw-bold text-dark fs-6">{{ $item->nama_mapel }}</div>
                            </td>
                            <td class="text-end">
                        ...
                        <tr>
                            <td colspan="4">
                                <div class="text-center py-5">
                                    ...
                                    <h6 class="fw-bold text-secondary">Belum ada data mata pelajaran</h6>
                                    <small class="text-muted">Silakan sesuaikan filter Anda atau tambahkan mata pelajaran baru.</small>
                                </div>
                            </td>
                        </tr>
                        @endforelse
            ...
            <div class="d-flex justify-content-end mt-4 pagination-container">
                {{ $mapels->links('vendor.pagination.bootstrap-4') }}
            </div>
...
document.querySelectorAll('.form-delete').forEach(function(form){
    form.addEventListener('submit', function(e){
        ...
        Swal.fire({
            ...
            text: 'Data yang berkaitan dengan mata pelajaran ini kemungkinan akan terpengaruh.',
            icon: 'warning',

    ...
    <div class="page-header mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            <div>
                ...
                <p class="text-light opacity-75 mb-0 small">Tetapkan guru untuk mengajar mata pelajaran di kelas tertentu.</p>
            </div>
            ...
            <form action="{{ route('guru-mapel.store') }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <small class="text-muted d-block mt-2">Centang satu atau lebih kelas yang diampu guru.</small>
                    </div>
